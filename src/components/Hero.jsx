...
const generatePDF = () => {
  ...
  return (
    <section className="mx-auto flex max-w-7xl flex-col items-center px-8 pt-20 text-center">
      ...
      {/* Planner Output */}
{planner && (
  <div className="mt-10 w-full max-w-7xl rounded-2xl border border-violet-500/30 bg-white/5 p-6 text-left backdrop-blur-xl">
...
<div className="grid auto-rows-fr grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
  ...
  {tasks.map((task, index) => (
    <div
      key={index}
      className={`flex h-full flex-col rounded-xl border px-6 py-4 transition-all duration-300 ${
        task.completed
  ...
  {task.content
    ...
    <div className="mt-auto pt-4">
        <button
          ...
          className={`w-full rounded-lg px-5 py-2 font-semibold transition ${
            task.completed
